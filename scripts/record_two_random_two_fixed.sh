...
#
# Usage:
#   bash scripts/record_two_random_two_fixed.sh CU
#   bash scripts/record_two_random_two_fixed.sh HK
#   bash scripts/record_two_random_two_fixed.sh all
#   RESUME=true bash scripts/record_two_random_two_fixed.sh CU
#
